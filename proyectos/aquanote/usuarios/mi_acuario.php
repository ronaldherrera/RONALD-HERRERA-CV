...
$parametros_info = [
    ...
    'pH' => ['🧪', 'Potencial de hidrógeno, nivel de acidez/alcalinidad del agua, afecta directamente a la salud de peces y plantas.'],
    ...
    'NH₃ / NH₄' => ['☠️', 'Amoniaco, altamente tóxico si no hay filtración biológica efectiva.'],
    ...
    'Ca' => ['🪨', 'Calcio, necesario para corales y esqueletos duros.'],
    'Mg' => ['🧲', 'Magnesio, regula el calcio, mantiene estabilidad.'],
    'Alcalinidad' => ['🧪', 'Mantiene el pH estable en acuarios marinos y plantados.'],
    'CO₂' => ['🫧', 'Dióxido de carbono disuelto, fundamental en acuarios plantados para la fotosíntesis.'],
    'Fe' => ['🧪', 'Hierro, nutriente clave para el crecimiento de plantas.'],
    'PO₄' => ['🧪', 'Fosfatos, nutriente esencial en pequeñas cantidades; en exceso, provoca algas.'],
    'Potasio (K)' => ['⚡', 'Potasio, macronutriente esencial para las plantas acuáticas.'],
